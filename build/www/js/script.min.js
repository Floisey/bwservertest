...
function loadBonzis(a) {
    loadQueue.loadManifest([
        { id: "bonziAqua", src: "./img/bonzi/aqua.png" },
...
function loadHats(a) {
    loadQueue.loadManifest([
        { id: "unicorn", src: "./img/hat/unicorn.webp" } ]),
        loadQueue.on(
            "fileload",
            function (a) {
                loadDone.push(a.item.id);
...
var _createClass = (function () {
                    ...
                    build: function (a, b) {
                        return {
                            items: {
                                ...
                                // JEJ! WHAT A FUCKING PUSSY! DISABLING BANS? WHAT THE ACTUAL FUCK JEJ
                            },
                        };
                    },
                ...
                },
              {
                ...
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialogCont.html(" <video width='173' loop autoplay controls id='bonziworld-video'><source src='" + a + "' type='video/mp4' loop>Your browser does not support the video tag.</video> "), this.$dialog.show();
                        }
                    },
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialogCont.html("<img width='173' src='" + a + "'></img>"), this.$dialog.show();
                        }
                    },
                },
                {
                    ...
                    value: function (a) {
                        if (!this.mute) {
                            var b = "embed";
                            this.$dialogCont.html("<iframe width='173' height='173' src='" + a + "'></iframe>"), this.$dialog.show();
                        }
                    },
                },
            {
    ...
    BonziData = {
        ...
        event_list_joke_mid: [
            ...
            [
                { type: "text", text: "What did Fune say to the ZIP file?" },
                { type: "text", text: "WE ALL LOVE CHILD PORN!!!" },
                { type: "text", text: "Don't take this out of context, faggot." },
            ],
        ],
        event_list_joke_end: [
            [
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow", "pope"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziAqua", "bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziDiamond", "bonziEmerald", "bonziGold", "bonziGreen", "bonziLime", "bonziOrange", "bonziPink", "bonziPurple", "bonziRed", "bonziPink", "bonziWhite", "bonziYellow", "topjej"];
...
$(function () {
    $("#login_go").click(loadTest),
        ...
        socket.on("loginFail", function (a) {
            var b = { nameLength: "Name too long." };
            $("#login_card").show(),
                $("#login_load").hide(),
                $("#login_error")
                    .show()
